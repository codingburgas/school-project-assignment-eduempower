...
int progMenu() {
    ...
    Texture2D progButtonImg = LoadTexture("../resources/Programming.png");
    ...
    int yOffset = 60;
    int xOffsetProg = 145; // Top left corner
    ...
    int xOffsetLessons = xOffsetProg + progButtonImg.width + buttonGap - 230; // Right of physics button
    int yOffsetLesson1 = yOffset + progButtonImg.height + buttonGap + 150;
